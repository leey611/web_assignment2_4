...
//Event Code
	...
	// var makeLinesLonger = function(linesClass){
	// 	document.querySelectorAll(`.${linesClass}`).style.height += "5px";
	// 	// var linesLength = targetelement.style.height += "5px";
	// }

	// var linesPress = function(patternUnitClass){
	// 	var lines = document.querySelectorAll(`.${patternUnitClass}`);
	// 	lines.addEventListener("keypress", function(){
	// 		makeLinesLonger(lines);
	// 	})
	// }
	...
	// 	makeLinesLonger(document.querySelectorAll("#patternUnit"));
	// }
